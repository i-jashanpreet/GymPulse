    ...
    <div className={`${styles.screen} ${styles.homeScreen}`}>
      <div className={styles.dashboardLayout}>
        ...
        <div className={styles.liveViewHeader}>
          ...
          <p>Today, {new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'long' })}</p>
        </div>
        ...
        <div className={styles.analyticsContainer} style={{ paddingTop: '12px' }}>
          ...
          <div className={styles.highlightsGrid} style={{ marginTop: '-8px' }}>
            <div className={styles.highlightCard} style={{ padding: '12px' }}>
              ...
              <div className={`${styles.highlightTrend} ${styles.negative}`}>Most Crowded</div>
            </div>

            <div className={styles.highlightCard} style={{ padding: '12px' }}>
              <h4 style={{ fontSize: '10px' }}>Quiet Time</h4>
              <div className={styles.highlightValue} style={{ fontSize: '15px' }}>{defaultDays[selectedDayIndex]?.lessCrowdTime}</div>
              <div className={`${styles.highlightTrend} ${styles.positive}`}>Less Crowded</div>
            </div>
          </div>
        </div>
